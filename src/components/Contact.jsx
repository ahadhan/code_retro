...
//                 <div className='absolute -left-10 top-0 hidden h-full w-72 overflow-hidden sm:block lg:left-20 lg:w-96'>
//                     <ImageClipBox clipClass={"contact-clip-path-1"}
//                         src="img/contact-1.webp" alt="contact" />
...
//                         Let's build the<br />  Business together <br />you dream of
//                     </p>
